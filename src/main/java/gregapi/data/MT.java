...
public class MT {
	...
	static OreDictMaterial copper         () {return noblemetal  ( 290, "Copper"         , "Cu"    ,  29,  34,  1357,  2835,  8.96      , SET_COPPER  , 255, 130,  90     , UUM        , COPPER_GROUP   , G_INGOT_MACHINE_ORES, WASHING_PERSULFATE, SOFT, FURNACE, EXTRUDER_SIMPLE, MORTAR, MOLTEN, RAILS,DECOMPOSABLE,ELECTROLYSER              ).aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1               );}
	...
	// I delete most of unknown elements
	...
	V2O5                    = dustelec   ( 8234, "Vanadium Pentoxide"    , SET_FINE              ,  50,  50,  50, 255, WASHING_FIRESTONE, MAGNETIC_PASSIVE)                                                                                                      .uumMcfg( 0, V              , 2*U, O                , 5*U)                                                                                                  .addSourceOf(V).setSmelting(V, U7), VanadiumPentoxide = V2O5,
...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	AnnealedCopper          = metalmachnd   ( 8640, "Annealed Copper"       , SET_COPPER            , 255, 100,   0     , MOLTEN, FURNACE, EXTRUDER_SIMPLE, MORTAR, WIRES, RAILS, SOFT)                                                                             .uumAloy( 0, Cu             , 1*U)                                                                                                                          .aspects(TC.METALLUM, 2, TC.PERMUTATIO  , 1).setPulver(Cu, U).steal(Cu).setGenerifying(Cu),
	CopperAnodeMud          = mixdust       ( 8629, "Copper Anode Mud"        , SET_DULL              ,  80,  80,  80, 255, UNRECYCLABLE)                                                                                                                       .setMcfg(10, Cu,25*U10,Ag,50*U10,Au,5*U10,Pb,5*U10,Sb,10*U10,Bi,5*U10),
...
//          Al                      .addAlloyingRecipe(new OreDictConfigurationComponent( 1, OM.stack(OREMATS.Bauxite               , 2*U), OM.stack(K                  , 1*U)));
			...
			String tMakeAnnealedCopper =
			  "Making Annealed Copper is a electrochemistry process. You will need an LV Electrolyzer. As a by-product, copper anode mud is a source of Au and Ag, green vitriol and white vitriol will give back you Fe and Zn";
