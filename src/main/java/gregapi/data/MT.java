...
//  HexoriumRainbow         = hexorium      ( 9242, 224, 224, 224, DYE_INDEX_White    ),
	...
	AnnealedCopper          = metalmachnd   ( 8640, "Annealed Copper"       , SET_COPPER            , 255, 100,   0     , MOLTEN, FURNACE, EXTRUDER_SIMPLE, MORTAR, WIRES, RAILS, SOFT, G_DUST)                                                                                                                                                                                                                                                                               .aspects(TC.METALLUM, 2, TC.PERMUTATIO  , 1).steal(Cu).setGenerifying(Cu),
