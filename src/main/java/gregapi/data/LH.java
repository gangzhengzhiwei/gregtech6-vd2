...
public class LH {
	...
	public static String format(String aKey, Object... args) {
		String tFormat = LanguageHandler.translate(aKey);
		try{
			return String.format(tFormat, args);
		} catch (IllegalFormatConversionException e) {
			e.printStackTrace(ERR);
			ERR.printf("%s : %s%n", tFormat, Arrays.toString(args));
			throw e;
		}
	}
