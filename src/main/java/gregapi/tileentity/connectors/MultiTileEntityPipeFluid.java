...
public class MultiTileEntityPipeFluid extends TileEntityBase10ConnectorRendered implements ITileEntityQuickObstructionCheck, IFluidHandler, ITileEntityGibbl, ITileEntityTemperature, ITileEntityProgress, ITileEntityServerTickPre, IMTE_GetCollisionBoundingBoxFromPool, IMTE_OnEntityCollidedWithBlock {
	 ...
	 * May use up to 20 IDs, even if it is just 9 right now!
	 */
	...
	public static void addFluidPipes(int aID, int aCreativeTabID, long aStat, boolean aGasProof, boolean aAcidProof, boolean aPlasmaProof, boolean aMagicProof, boolean aContactDamage, boolean aFlammable, boolean aRecipe, boolean aBlocking, MultiTileEntityRegistry aRegistry, MultiTileEntityBlock aBlock, Class<? extends TileEntity> aClass, long aMaxTemperature, OreDictMaterial aMat) {
		...
		OreDictManager.INSTANCE.setTarget_(OP.pipeQuadruple     , aMat, aRegistry.add("Quadruple " + aMat.getLocal() + " Fluid Pipe"      , "Fluid Pipes", aID+ 5, aCreativeTabID, aClass, aMat.mToolQuality, 16, aBlock, UT.NBT.make(NBT_MATERIAL, aMat, NBT_HARDNESS, aBlocking?2.0F:1.0F, NBT_RESISTANCE, aBlocking?6.0F:2.0F, NBT_COLOR, UT.Code.getRGBInt(aMat.fRGBaSolid), NBT_PIPERENDER, 0, NBT_DIAMETER, PX_P[16], NBT_CONTACTDAMAGE, aContactDamage, NBT_TANK_CAPACITY, aStat* 6L, NBT_OPAQUE, aBlocking, NBT_GASPROOF, aGasProof, NBT_ACIDPROOF, aAcidProof, NBT_PLASMAPROOF, aPlasmaProof, NBT_MAGICPROOF, aMagicProof, NBT_FLAMMABILITY, aFlammable ? 150 : 0, NBT_TEMPERATURE, aMaxTemperature, NBT_TANK_COUNT, 4), "PP", "PP", 'P', OP.pipeMedium.dat(aMat)), T, F, T);
		OreDictManager.INSTANCE.setTarget_(OP.pipeQuadrupleSmall, aMat, aRegistry.add("Small Quadruple " + aMat.getLocal() + " Fluid Pipe", "Fluid Pipes", aID+ 7, aCreativeTabID, aClass, aMat.mToolQuality, 16, aBlock, UT.NBT.make(NBT_MATERIAL, aMat, NBT_HARDNESS, aBlocking?2.0F:1.0F, NBT_RESISTANCE, aBlocking?6.0F:2.0F, NBT_COLOR, UT.Code.getRGBInt(aMat.fRGBaSolid), NBT_PIPERENDER, 0, NBT_DIAMETER, PX_P[12], NBT_CONTACTDAMAGE, aContactDamage, NBT_TANK_CAPACITY, aStat* 2L, NBT_OPAQUE, aBlocking, NBT_GASPROOF, aGasProof, NBT_ACIDPROOF, aAcidProof, NBT_PLASMAPROOF, aPlasmaProof, NBT_MAGICPROOF, aMagicProof, NBT_FLAMMABILITY, aFlammable ? 150 : 0, NBT_TEMPERATURE, aMaxTemperature, NBT_TANK_COUNT, 4), "PP", "PP", 'P', OP.pipeSmall.dat(aMat)), T, F, T);
		OreDictManager.INSTANCE.setTarget_(OP.pipeQuadrupleTiny , aMat, aRegistry.add("Tiny Quadruple " + aMat.getLocal() + " Fluid Pipe" , "Fluid Pipes", aID+ 8, aCreativeTabID, aClass, aMat.mToolQuality, 16, aBlock, UT.NBT.make(NBT_MATERIAL, aMat, NBT_HARDNESS, aBlocking?2.0F:1.0F, NBT_RESISTANCE, aBlocking?6.0F:2.0F, NBT_COLOR, UT.Code.getRGBInt(aMat.fRGBaSolid), NBT_PIPERENDER, 0, NBT_DIAMETER, PX_P[ 8], NBT_CONTACTDAMAGE, aContactDamage, NBT_TANK_CAPACITY, aStat    , NBT_OPAQUE, aBlocking, NBT_GASPROOF, aGasProof, NBT_ACIDPROOF, aAcidProof, NBT_PLASMAPROOF, aPlasmaProof, NBT_MAGICPROOF, aMagicProof, NBT_FLAMMABILITY, aFlammable ? 150 : 0, NBT_TEMPERATURE, aMaxTemperature, NBT_TANK_COUNT, 4), "PP", "PP", 'P', OP.pipeTiny.dat(aMat)), T, F, T);
        // To avoid to break the save and localization keys, keep pipeNonuple's aID
		OreDictManager.INSTANCE.setTarget_(OP.pipeNonuple       , aMat, aRegistry.add("Nonuple " + aMat.getLocal() + " Fluid Pipe"        , "Fluid Pipes", aID+ 6, aCreativeTabID, aClass, aMat.mToolQuality, 16, aBlock, UT.NBT.make(NBT_MATERIAL, aMat, NBT_HARDNESS, aBlocking?2.0F:1.0F, NBT_RESISTANCE, aBlocking?6.0F:2.0F, NBT_COLOR, UT.Code.getRGBInt(aMat.fRGBaSolid), NBT_PIPERENDER, 0, NBT_DIAMETER, PX_P[16], NBT_CONTACTDAMAGE, aContactDamage, NBT_TANK_CAPACITY, aStat* 2L, NBT_OPAQUE, aBlocking, NBT_GASPROOF, aGasProof, NBT_ACIDPROOF, aAcidProof, NBT_PLASMAPROOF, aPlasmaProof, NBT_MAGICPROOF, aMagicProof, NBT_FLAMMABILITY, aFlammable ? 150 : 0, NBT_TEMPERATURE, aMaxTemperature, NBT_TANK_COUNT, 9), "PPP", "PPP", "PPP", 'P', OP.pipeSmall.dat(aMat)), T, F, T);
		OreDictManager.INSTANCE.setTarget_(OP.pipeNonupleTiny   , aMat, aRegistry.add("Tiny Nonuple " + aMat.getLocal() + " Fluid Pipe"   , "Fluid Pipes", aID+ 9, aCreativeTabID, aClass, aMat.mToolQuality, 16, aBlock, UT.NBT.make(NBT_MATERIAL, aMat, NBT_HARDNESS, aBlocking?2.0F:1.0F, NBT_RESISTANCE, aBlocking?6.0F:2.0F, NBT_COLOR, UT.Code.getRGBInt(aMat.fRGBaSolid), NBT_PIPERENDER, 0, NBT_DIAMETER, PX_P[10], NBT_CONTACTDAMAGE, aContactDamage, NBT_TANK_CAPACITY, aStat    , NBT_OPAQUE, aBlocking, NBT_GASPROOF, aGasProof, NBT_ACIDPROOF, aAcidProof, NBT_PLASMAPROOF, aPlasmaProof, NBT_MAGICPROOF, aMagicProof, NBT_FLAMMABILITY, aFlammable ? 150 : 0, NBT_TEMPERATURE, aMaxTemperature, NBT_TANK_COUNT, 9), "PPP", "PPP", "PPP", 'P', OP.pipeTiny.dat(aMat)), T, F, T);
	...
	@Override public int getIconIndexConnected              (byte aSide, byte aConnections, float aDiameter, int aRenderPass) {
        //The floating-point numbers in the PX_P array are exactly representable in binary format under IEEE 754 and may be directly compared for magnitude without precision loss.
        if (mTanks.length>=9) {
            return aDiameter<=PX_P[10]?OP.pipeNonupleTiny.mIconIndexBlock:OP.pipeNonuple.mIconIndexBlock;
        }
        if (mTanks.length>=4) {
            return aDiameter<=PX_P[8]?OP.pipeQuadrupleTiny.mIconIndexBlock:(aDiameter<=PX_P[12]?OP.pipeQuadrupleSmall.mIconIndexBlock:OP.pipeQuadruple.mIconIndexBlock);
        }
        if (aDiameter<=PX_P[4])
            return OP.pipeTiny.mIconIndexBlock;
        if (aDiameter<=PX_P[6])
            return OP.pipeSmall.mIconIndexBlock;
        if (aDiameter<=PX_P[8])
            return OP.pipeMedium.mIconIndexBlock;
        if (aDiameter<=PX_P[12])
            return OP.pipeLarge.mIconIndexBlock;
        return OP.pipeHuge.mIconIndexBlock;
    }
